...
QBShared.Vehicles = {
	...
	['chargerdemon'] = {
		['name'] = 'Dodge Charger Demon Animated',
		['brand'] = 'Dodge',
		['model'] = 'chargerdemon',
		['price'] = 99999999,
		['category'] = 'vip',
